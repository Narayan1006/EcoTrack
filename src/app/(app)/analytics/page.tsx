      ...
      <div className="grid grid-4 stagger" style={{ marginBottom: 24 }}>
        <div className="stat-card">
          ...
          <div className="stat-info">
            <h4>Total CO₂</h4>
            <div>
              <span className="stat-value">{total.toFixed(0)}</span>
          ...
          <div className="stat-info">
            ...
            <div>
              <span
                ...
                style={{ color: avg < AVERAGES.india ? "#10B981" : "#EF4444" }}
              >
                {avg < AVERAGES.india ? "Below" : "Above"}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-2" style={{ marginBottom: 24 }}>
        ...
        <div className="card animate-in">
          <div className="card-header">
            <h3>Daily Emissions by Category</h3>
          </div>
            ...
            <div key={item.label} className="comparison-bar-container">
              <div className="comparison-label">
                ...
                <span style={{ fontWeight: 600 }}>
                  {item.value.toFixed(1)} kg CO₂/day
                </span>
              </div>
              <div className="comparison-bar">
                <div
                  ...
                  style={{
                    width: `${Math.min((item.value / AVERAGES.usa) * 100, 100)}%`,
            ...
            <BarChart data={dailyData.slice(-14)}>
              <XAxis
                ...
                tickFormatter={(d: string) => {
                  const day = new Date(d).toLocaleDateString("en", {
                    weekday: "short",
                  });
                  return `${day} ${d.slice(8)}`;
                }}
              />
              <YAxis width={40} />
              <Tooltip

...
describe('Emission Engine (src/backend/emissions.ts)', () => {
  describe('calculateEmission', () => {
    it('calculates correct CO2 for car_petrol', () => {
      // car_petrol factor is 0.21. So 10 * 0.21 = 2.1
      expect(calculateEmission('car-petrol', 10)).toBe(2.1);
    });

    it('calculates correct CO2 for meat_meal', () => {
      // meat_meal factor is 3.3. So 2 * 3.3 = 6.6
  ...
  describe('Aggregations', () => {
    ...
    describe('getTotalCo2', () => {
      ...
      it('filters by date range', () => {
        expect(getTotalCo2(mockActivities, '2026-06-12', '2026-06-12')).toBe(4.2);
        expect(getTotalCo2(mockActivities, '2026-06-11', '2026-06-11')).toBe(5.4);
      });
    });
